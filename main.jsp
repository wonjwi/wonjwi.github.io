...
<!-- 시스템의 기본 경로, localhost:8080 같은 것 -->
			...
			<div class="collapse navbar-collapse navbar-right" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="#">그룹 활동</a></li>
							<li><a href="#">자유게시판</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							훈련정보 <span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
							<li><a href="#">수강후기</a></li>
							<li><a href="#">지역별 검색</a></li>
							<li><a href="#">과정별 검색</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
...
<div class="container">
	...
	<div class="jumbotron" style="margin: 30px;">
	  <h1>Hello, world!</h1>
	  <p>어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구 어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구 어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구
	  	어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구 어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구 어쩌구저쩌구 어쩌구 저쩌구 어쩌구저쩌구 어쩌구</p>
